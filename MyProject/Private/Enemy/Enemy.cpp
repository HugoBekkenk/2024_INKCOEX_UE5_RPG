...
void AEnemy::Die_Implementation()
{
	...
	SpawnSoul();
	//GetWorldTimerManager().SetTimer(SoulSpawnTimer, this, &AEnemy::SpawnSoul, 1.f);
}
...
{
	if (InTargetRange(PatrolTarget, PatrolRadius) && CombatTarget == nullptr)
	{
...
void AEnemy::HealthBarFacePlayer()
{
	if (HealthBarWidget)
	{
...
void AEnemy::PawnSeen(APawn* SeenPawn)
{
	const bool bShouldChaseTarget =
		...
		EnemyState != EEnemyState::EES_Chasing &&
		EnemyState < EEnemyState::EES_Attacking &&
		SeenPawn->ActorHasTag(TargetActorTag) &&
